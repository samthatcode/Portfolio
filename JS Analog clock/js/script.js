...
function drawClock() {
  ...
  for (i = 0; i < 60; i++) {
    ...
    var x1 = (canvas.width / 2) + Math.cos(angle) * (size);
    var y1 = (canvas.height / 2) + Math.sin(angle) * (size);
    var x2 = (canvas.width / 2) + Math.cos(angle) * (size - (size / 30));
    var y2 = (canvas.height / 2) + Math.sin(angle) * (size - (size / 30));
    ctx.moveTo(x1, y1);
    ctx.lineTo(x2, y2);
    ctx.strokeStyle = '#000';
    ctx.stroke();
...
function showSeconds() {
  ...
  ctx.lineTo((canvas.width / 2 + Math.cos(angle) * size), canvas.height / 2 + Math.sin(angle) * 20);
...
function showMinutes() {
  ...
  ctx.beginPath();
  ctx.moveTo(canvas.width / 2, canvas.height / 2);
  ctx.lineTo((canvas.width / 2 + Math.cos(angle) * size / 1.1), canvas.height / 2 + Math.sin(angle) * size / 1.1);
  ctx.strokeStyle = '#000';
  ctx.stroke();
}
...
function showHours() {
  ...
  ctx.beginPath();
  ctx.moveTo(canvas.width / 2, canvas.height / 2);
  ctx.lineTo((canvas.width / 2 + Math.cos(angle) * size / 1.5), canvas.height / 2 + Math.sin(angle) * size / 1.5);
  ctx.strokeStyle = '#000';
  ctx.stroke();
